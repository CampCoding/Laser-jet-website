...
export default function Navbar() {
 ...
 <header className="w-full bg-[#0648af] pr-4 container gap-2 flex flex-col lg:flex-row">
  {/* Left Section */}
  <div className= "gap-1 lg:gap-3 ml-auto items-start lg:items-center flex-row w-auto lg:w-[400px] flex items-center text-white font-semibold cursor-pointer pt-2 pb-2">
  ...
  {/* Right Section */}
  <div className= "gap-1 lg:gap-3 mr-auto w-auto lg:w-[400px] flex text-white font-semibold cursor-pointer pt-2 pb-2 items-start lg:items-center flex-row">
