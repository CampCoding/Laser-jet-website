...
import { Facebook, Instagram, Whatsapp, Phone, MapPin, Mail, Youtube } from "lucide-react";
  ...
  return (
    <footer className="mt-16 bg-gradient-to-b from-gray-50 to-gray-100 text-gray-700 border-t border-gray-200">
      <div className="container mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        {/* Logo + Description */}
        <div>
          <h2 className="text-2xl font-bold text-blue-700 mb-4">LaserJet</h2>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li><Link href="/products" className="hover:text-blue-600 transition">المنتجات</Link></li>
            <li><Link href="/offers" className="hover:text-blue-600 transition">العروض</Link></li>
            <li><Link href="/contact" className="hover:text-blue-600 transition">تواصل معنا</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link href="/policy" className="hover:text-blue-600 transition">سياسة الاستبدال</Link></li>
            <li><Link href="/faq" className="hover:text-blue-600 transition">الأسئلة الشائعة</Link></li>
            <li><Link href="/shipping" className="hover:text-blue-600 transition">الشحن والدفع</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center gap-3">
              ...
              <span>support@laserjet.com</span>
            </li>
            <li className="flex items-center gap-3">
